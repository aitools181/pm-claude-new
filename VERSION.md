...
|---------|------|---------|
| 5.7 | 2026-08-13 | Production-stability release: fixes Next.js Suspense/prerender deployment failures, preserves typed shared-control refs, includes native Alpine build dependencies, and exposes clear per-device and all-session sign-out actions. |
