import { pgTable, uuid, text, timestamp, integer, boolean, date, uniqueIndex, index, check, } from "drizzle-orm/pg-core";
...
export const projects = pgTable("projects", {
    ...
    nextKeySeq: integer("next_key_seq").default(1).notNull(), // atomic counter
    name: text("name").notNull(),
