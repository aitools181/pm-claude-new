import { pgTable, uuid, text, doublePrecision, timestamp, jsonb, index, uniqueIndex } from "drizzle-orm/pg-core";
...
export const dashboards = pgTable("dashboards", {
  ...
  visibility: text("visibility").default("org").notNull(),   // private|org
